document.addEventListener("DOMContentLoaded", function () {
  ...
  const boardifyModal = document.getElementById("boardifyModal");
  const openBoardifyBtn = document.getElementById("openBoardifyModalBtn");
  const closeBoardifyBtn = document.getElementById("closeBoardifyModalBtn");

  openBoardifyBtn.addEventListener("click", function () {
    boardifyModal.style.display = "block";
  });

  closeBoardifyBtn.addEventListener("click", function () {
    boardifyModal.style.display = "none";
  });

  window.addEventListener("click", function (event) {
    if (event.target === boardifyModal) {
      boardifyModal.style.display = "none";
    }
  });
